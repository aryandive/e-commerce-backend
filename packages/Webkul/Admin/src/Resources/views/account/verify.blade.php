            ...
            <div class="flex w-full max-w-[420px] flex-col items-center gap-6">
                ...
                <div class="box-shadow w-full overflow-hidden rounded-xl bg-white dark:bg-gray-900">
                    ...
                    <div class="flex flex-col items-center gap-2 px-8 pt-8 text-center">
                        <!-- Lock Badge -->
                        <div
                            class="mb-2 flex h-14 w-14 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-950">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8"
                                stroke="currentColor" class="h-7 w-7 text-blue-600 dark:text-blue-400">
                    ...
                    <!-- Verification Form -->
                    <x-admin::form :action="route('admin.two_factor.verify.store')" method="POST" class="w-full">
                        <div class="px-8 py-6">
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label
                                    class="required !text-xs !font-semibold !uppercase !tracking-wide !text-gray-500 dark:!text-gray-300">
                                ...
                                <x-admin::form.control-group.control type="text"
                                    ...
                                    id="code" name="code" rules="required|numeric|digits:6" inputmode="numeric"
                            ...
                            <!-- Verify Button -->
                            <button type="submit" class="primary-button mt-2 w-full !justify-center !py-2.5 text-base"
                ...
                <div class="text-sm font-normal">
                    @lang('admin::app.users.sessions.powered-by-description', [
                        'bagisto' => '<a class="text-blue-600 hover:underline" href="https://psinfo.tech/">PS InfoTech</a>',

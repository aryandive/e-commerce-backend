...
// Z PAD custom static routes overriding Bagisto core where necessary

Route::group(['middleware' => ['web', 'theme', 'locale', 'currency']], function () {
    // Custom Home view overriding the default Bagisto home
    Route::get('/', function () {
    ...
    Route::get('/shop', [\Webkul\Shop\Http\Controllers\SearchController::class, 'index'])->name('zpad.shop.index');
